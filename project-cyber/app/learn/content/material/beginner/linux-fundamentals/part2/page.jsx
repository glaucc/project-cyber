  ...
  const questions = [
    ...
    },
    {
      ...
      correctAnswer: "nc -l -p 12345",
      hint: "You will need two switches here. Read the manual page to find the shortcut for netcat, as well as the two switches you'll need.",
    },
  ...
  const Learning = () => {
    ...
    return (
      <div className={styles.container}>
        <Head>
          <title>Linux Part 2</title>
          <meta name="description" content="Linux Part 2 Learning Page for Learners" />
        </Head>

        <main className={styles.main}>
          <div className={styles.textSection}>
            <div className={styles.contentSection}>
              <h1 className={styles.heading}>Linux Part 2</h1>
              <p>
