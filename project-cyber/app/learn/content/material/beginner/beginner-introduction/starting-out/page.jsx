...
<ul>
  <li>you enjoy understanding how things work</li>
  <li>you are analytical</li>
  <li>you like thinking out of the box</li>
</ul>
<br></br>
<p>
...
<ul>
  ...
  <li>use of programming languages to write various scripts</li>
</ul>
<br></br>
<p>More recently, cloud security has also been gaining popularity as various organisations are now shifting their infrastructure to cloud providers such as AWS and Azure.</p>
          ...
          {showResult && ( // Show result only when showResult is true (after clicking Check Answer)
            <div className={styles.result}>
              {answer.toLowerCase() === correctAnswer.toLowerCase() ? (
                <p className={styles.correctAnswer}>Correct! Your answer is right.</p>
              ) : (
                <p className={styles.incorrectAnswer}>Sorry, your answer is incorrect. Try again!</p>
              )}
            </div>
          )}
        </div>
